<template>
  <div class="product-list-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h3 class="product-title">예금 상품</h3>
    ...
    <div v-if="store.depositProducts" class="table-responsive">
      <table class="table custom-table">
        ...
        <tbody>
          <tr v-for="product in paginatedProducts" :key="product.id">
            ...
            <td>
              <RouterLink :to="{ name: 'deposit-product-detail', params: { 'id': product.id }}" class="product-link">
                {{ product.fin_prdt_nm }}
              </RouterLink>
            </td>
